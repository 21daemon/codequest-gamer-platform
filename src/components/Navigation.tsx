...
const NavigationItem = ({ to, label, icon, mobile = false }: NavigationItemProps) => (
    ...
    return (
      ...
      `}>
        <ul className="flex flex-col p-4">
          <NavigationItem to="/dashboard" label="Challenges" icon={<Code size={18} />} mobile />
          <NavigationItem to="/leaderboard" label="Leaderboard" icon={<Trophy size={18} />} mobile />
          <NavigationItem to="/community" label="Community" icon={<Users size={18} />} mobile />
          <NavigationItem to="/resources" label="Resources" icon={<Book size={18} />} mobile />
        </ul>
      </nav>
    );
  }
  ...
  return (
    <NavigationMenu className="hidden md:flex">
      <NavigationMenuList>
        ...
        <NavigationMenuItem>
          <Link to="/leaderboard" className={cn(navigationMenuTriggerStyle(), "bg-transparent")}>
